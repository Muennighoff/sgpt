...
do
   echo "$i"
   python beir_openai_embeddings_batched_parallel.py --parallelworkers 1 --batchsize 100 --waitinterval 10 --datapath ../datasets/ --engine curie --endpoint similarity --dataset "$i"
done
